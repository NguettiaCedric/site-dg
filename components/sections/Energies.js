                    ...
                    <div className="row">
                        ...
                        <div className="news-block service-block-two col-lg-4 col-md-6 coll-md-12 wow fadeInUp">
                            <div className="inner-box">
                                ...
                                <div className="title-box">
                                    <h5 className="title"><Link href="/page-service-details">Suivi de chantiers via outils digitaux (BIM, IoT)</Link></h5>
                                </div>
                                <div className="content-box">
                                    <i className="icon flaticon-digital-services" />
                                    <div className="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry...</div>
                        ...
                        <div className="news-block service-block-two col-lg-4 col-md-6 coll-md-12 wow fadeInUp">
                            <div className="inner-box">
                                ...
                                <div className="title-box">
                                    <h5 className="title"><Link href="/page-service-details">Ingénierie structurelle, thermique et environnementale</Link></h5>
                                </div>
                                <div className="content-box">
                                    <i className="icon flaticon-digital-services" />
                                    <div className="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry...</div>
                    ...
                    <div className="row">
                        ...
                        <div className="news-block service-block-two col-lg-4 col-md-6 coll-md-12 wow fadeInUp">
                            <div className="inner-box">
                                ...
                                <div className="title-box">
                                    <h5 className="title"><Link href="/page-service-details">Management de projets complexes (logements, bureaux)</Link></h5>
                                </div>
                                <div className="content-box">
                                    <i className="icon flaticon-digital-services" />
                                    <div className="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry...</div>
                        ...
                        <div className="news-block service-block-two col-lg-4 col-md-6 coll-md-12 wow fadeInUp">
                            <div className="inner-box">
                                ...
                                <div className="title-box">
                                    <h5 className="title"><Link href="/page-service-details">Normes HQE / LEED / ISO respectées</Link></h5>
                                </div>
                                <div className="content-box">
                                    <i className="icon flaticon-digital-services" />
                                    <div className="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry...</div>
