				...
				<div className="col-xl-8 col-lg-7">
					<div className="blog-details__left">
						...
						<div className="blog-details__content">
							...
							<h3 className="blog-details__title">La cybernétique : au cœur de l’intelligence des systèmes</h3>
							<p className="blog-details__text-2">
								À l’ère de l’automatisation et de l’intelligence artificielle, la cybernétique revient sur le devant de la scène. Cette discipline, qui étudie les systèmes de contrôle et 
								de communication chez les machines et les êtres vivants, inspire aujourd’hui les innovations les plus avancées.
							</p>
							<p className="blog-details__text-2">
								Des processus industriels autonomes à la prise de décision assistée par algorithmes, la cybernétique permet de concevoir des systèmes intelligents, capables d'apprendre, de s’adapter et d’interagir avec leur environnement. 
								Intégrée à des solutions comme SAP S/4HANA, elle ouvre la voie à une entreprise plus agile, plus prédictive et plus résiliente.
							</p>
							<p className="blog-details__text-2">
								La cybernétique n’est plus un concept du futur : elle est déjà au cœur de la performance digitale.
