...
export default function SolutionDurableResponsable() {
    return (
        <>
            ...
            <section className="services-section-two pt-5">
                ...
                <div className="auto-container">
                    <div className="sec-title text-center black">
                        ...
                        <h2>Solutions durables et éco-responsables<br/></h2>
                    </div>
                    <div className="row">
                        {/* Service Block Two */}
                        <div className="news-block service-block-two col-lg-4 col-md-6 coll-md-12 wow fadeInUp">
                            <div className="inner-box">
                                ...
                                <div className="title-box">
                                    <h5 className="title"><Link href="/page-service-details">Intégration de smart grids et systèmes de monitoring</Link></h5>
                                </div>
